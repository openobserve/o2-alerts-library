...
Production-ready Kubernetes observability alerts for OpenObserve, built on top of the [OpenObserve Collector](https://github.com/openobserve/openobserve-helm-chart/tree/main/charts/openobserve-collector).
Current alert and category counts are in [`PACKS.md`](../../PACKS.md), generated by CI.
